...
namespace TicTacToe_Console_C_Sharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int count = 0;
            for(int i = 0; i < 9; i++)  //Befüllen des Arrays
            {
                for(int j = 0; j < 9; j++)
                {
                    board[i,j] = " ";
            ...
            while (finish == false && gameOver == false)
            {
                ...
                while (onlyNumbersPlayer1 == false && finish == false && gameOver == false)
                {
                    ...
                    {   
                        ...
                        //wenn Eingabe == 1 - 81
                        if ((read1 >= 1 && read2 >= 1) && (read1 <= 9 && read2 <= 9))
                        {
                            ...
                            if (freeField == true)
                            {
                                ...
                                Console.WriteLine(board[1, 0] + " | " + board[1, 1] + " | " + board[1, 2] + " | " + board[1, 3] + " | " + board[1, 4] + " | " + board[1, 5] + " | " + board[0, 6] + " | " + board[0, 7] + " | " + board[0, 8]);
